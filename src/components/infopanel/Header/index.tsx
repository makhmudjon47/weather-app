    ...
    return (
        <div className="flex box-border h-24 m-0 p-0">
            <div className="flex-1 px-14 flex items-end">
                <input type="text" className="bottom-0 h-[fit-content] hover:border-primary-1 focus:border-primary-1 text-base w-full bg-transparent outline-none text-primary-1 border-b-[1px] border-primary leading-10" placeholder="Any location"/>
            </div>
